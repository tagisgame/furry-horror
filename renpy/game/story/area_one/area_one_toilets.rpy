...
label area_one_ToiletStall_Start:
    ...
    You have a terrible headache trying to remember anything that led to this particular moment."""

    if not vb_a1_toilets_player_start_over:
        player_thinking """Ah crap... Well, it seems I'm still at school.

        Why nobody came to help me? Didn't they notice someone has fainted in a toilet stall?
...
label area_one_Toilets_StayedDeath:
    ...
    You try to scream, but there is a hole in your neck. There is no face of yours any more.

    You lay lifeless on the floor in a puddle of blood that came straight from your carotid artery.
    ...
    Well, you get it. Are you happy now?
...
label area_one_Toilets:
    ...
    if not vb_a1_toilets_visited:
        ...
        This vison lasted only a second, and as your eyes got used to the light it all disappeared."""
